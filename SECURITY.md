...
Agent Wave is designed for local orchestration. Do not commit credentials, vendor tokens, private runtime artifacts, customer records, or machine-specific secrets.
